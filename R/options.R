...
#'   \item{\code{pcmin}:}{minimum number of levels for the smallest point on a \code{\link{powerCurve}}.}
#'   \item{\code{pcmax}:}{maximum number of points on the default \code{\link{powerCurve}}.}
#' }
#'
#' @examples
#'
