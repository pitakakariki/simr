...
Note that `period` is a categorical variable with 4 levels. `simr` will default to likelihood ratio test comparing `gm1` to the reduced model without the `period` term.
