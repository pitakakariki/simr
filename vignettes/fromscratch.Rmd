...
If pilot data is not available, \code{simr} can be used to create \code{lme4} objects from scratch as a starting point. This requires more paramters to be specified by the user. Values for these parameters might come from the literature or the user's own knowledge and experience.
